...
type Mailer struct {
	// mail.Dialer type is used for store mail.Dialer instance (used to connect to a SMTP server)
	dialer *mail.Dialer
	// sender information for your emails. Such as "Alice Smith <alice@example.com>"
	sender string
}
