...
// Convert the string "user" to a contextKey type and assign it to
// the userContextKey constant. We'll use this constant as the key for getting
// and setting user information in the request context.
